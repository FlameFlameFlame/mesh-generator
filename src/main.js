...
Object.assign(window, {
  applyGapRepairPreset,
  calculateAllShownTowerCoverage,
  calculateSelectedTowerCoverage,
  clearBbox,
  closeCoveragePopupWindow,
  closeInfoPopupWindow,
  closeLinkAnalysis,
  ...
  doRefreshProjects,
  doRenameProject,
  doResolveDuplicateSiteNames,
  doRunOptimization,
  doSaveSettings,
  onCoverageSourceModeChange,
  onGapRepairFilterChanged,
  onRunSelectionChanged,
  renderCoverage,
  renderTowerCoverage,
  rerenderEdges,
  ...
  toggleBboxMode,
  toggleCoverage,
  toggleCoveragePanelFromMap,
  toggleEdges,
  toggleElevation,
  toggleGridCells,
  toggleGridCellsFull,
  toggleInfoPanelFromMap,
  toggleLayer,
  toggleLayersPanelFromMap,
